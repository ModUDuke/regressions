...
#2) Calculate the correlation coefficient between our two variables of interest, the overall quality rating for each hospital in teh variable `Total.Performance.Score`, and the 30 Day mortality rate for pneumonia patients in the variable `score`.

cor()


# 2) Let's further analyze the relationship between the mortality score on pneumonia and a hospital's total performanc score. Plot the two variables on the same graph, and fit a line as well.
