...
*** =sample_code
```{r}
# 1) You will explore the relationship between hospital performance and mortality. First, use the head() command to take a look at the variable names, types, and some some initial values.


#2) Calculate the correlation coefficient between these variables.
