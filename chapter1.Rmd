...
# I HAVE DOWNLOADED THESE DATASETS, HAVEN'T ADDED THEM TO DATACAMP SERVERS THOUGH. NEED MERGING AND TRIMMING TO SMALL FILE SIZE.
...
***=solution
cor(hospitals$mortality, hospitals$performance)
ggplot(data=hospitals, aes(x=performance, y=mortality)) +
                  geom_point() +
