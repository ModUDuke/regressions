...
#2) Calculate the correlation coefficient between our two variables of interest, the overall quality rating for each hospital in the variable `Total.Performance.Score`, and the 30 Day mortality rate for pneumonia patients in the variable `score`.
...
```{r}
cor(Hospitals$score, Hospitals$Total.Performance.Score)
ggplot(data=Hospitals, aes(x=Total.Performance.Score, y=score)) +
                  geom_point() +
