...
--- type:NormalExercise lang:r xp:50 skills:1 key:1a2137dd19
## Interpreting Regressions
...
# Now for your first task: Create a variable named "residuals" in the WePhone dataset that estimates the PriceSold minus PredictedPriceSold

#---- Question 1-------------------------------------#
      WePhone$residuals<-
#----------------------------------------------------#

# Now create a variable in the WePhone dataset called residuals2, which is the WePhone residuals squared.
...
*** =solution
```{r}
WePhone$residuals<-WePhone$PriceSold-WePhone$PredictedPriceSold
WePhone$residuals2<-WePhone$residuals^2
Solution1<-sum(WePhone$residuals2)

```
*** =sct
```{r}
test_object("WePhone$residuals")
test_object("WePhone$residuals2")
test_object("WePhone$Solution1")
