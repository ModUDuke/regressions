...
msg2 = "If soda sales and music sales are positively connected, we might be onto something. But in order to say this is a causal effect, we also need to argue that this correlation is unconfounded by any other factors. Try again."
...
msg3 = "This answer is tricky. Remember, the dataset contains every relevant variable in the universe for determining outcomes. That should make findings from it generalizable beyond the dataset. Try again."
...
---
## Let’s Code: Creating a Regression Model with Interaction Effects
...
xp: 50
skills: 1
video_link: "//player.vimeo.com/video/293196284"
```
...
---
## Let’s Code: Practice with Survey Weights
...
xp: 50
skills: 1
video_link: "//player.vimeo.com/video/293196303"
```
...
`@sct`
```{r}
msg1 = "The company is looking for results on a pretty specific population - female college students in Los Angeles - rather than the general American population. Think about whether they really need to extrapolate from their survey sample and try again."
