...
msg4 = "The draft during the Vietnam War was just for men, so gender is not a factor in this case. Try again"
test_mc(correct = 3, feedback_msgs = c(msg1,msg2,msg3,msg4))
```
...
In this course, we've talked about using the Unconfoundedness Assumption with regression models to find causal effects in our data. But many analytical methods make no mention of the Unconfoundedness Assumption.  Can those ever support claims about causality?
